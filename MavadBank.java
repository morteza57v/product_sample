...
public class MavadBank {
    ...
    public MavadBank(String targetSchema, String sourceSchema, IdGenerator idGenerator, String Camunda, Connection connection , Connection connectiontarget, Connection connectionCamunda) {
    ...
    public void run() throws SQLException, ClassNotFoundException {
        ...
        String selectQuery = "select FLD_BANK_TYPE_ID,FLD_DESC from " +sourceSchema+".TBL_BANK_TYPE" ;
        //TODO: Organ code should be filled with personel code or smth like that!!!
        String insertQuery =
                "Insert into " + targetSchema + ".NAP_BANK " +
                        "(BANK_ID ,TITLE ) values (?,?)";
        ...
        while(resultSet.next()){
            ...
            insertStmt.setLong(1, Long.parseLong(FLD_BANK_TYPE_ID));
