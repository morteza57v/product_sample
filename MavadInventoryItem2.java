...
public class MavadInventoryItem2 {
    ...
    public MavadInventoryItem2(String targetSchema, String sourceSchema, IdGenerator idGenerator, String Camunda, Connection connection, Connection connectiontarget) {
    ...
    public void run() throws SQLException, ClassNotFoundException {
        ...
        String selectQuery = "select FLD_WAREHOUSE_EXITNARCOTIC_ID,FLD_NARCOTIC_TYPE_ID," +
                "FLD_MEASURMENT_UNIT_TYPE_ID,FLD_WAREHOUSE_EXIT_ID,FLD_AMOUNT,FLD_AMOUNT_LAFAFEH from " + sourceSchema + ".TBL_WAREHOUSE_EXITNARCOTIC";
