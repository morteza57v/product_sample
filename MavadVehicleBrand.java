...
public class MavadVehicleBrand {
    ...
    public MavadVehicleBrand(String targetSchema, String sourceSchema, IdGenerator idGenerator, String Camunda, Connection connection , Connection connectiontarget) {
    ...
    public void run() throws SQLException, ClassNotFoundException {
        ...
        String selectQuery = "select FLD_CAR_TYPE,FLD_DESC from " +sourceSchema+".TBL_CAR_TYPE" ;


        //TODO: Organ code should be filled with personel code or smth like that!!!
        String insertQuery = "Insert into " + targetSchema +".NAP_VEHICLE_BRAND(VEHICLE_BRAND_ID, TITLE)\n" +
                "values (?,?)\n";
