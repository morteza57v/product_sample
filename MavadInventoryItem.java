...
public class MavadInventoryItem {
    ...
    public MavadInventoryItem(String targetSchema, String sourceSchema, IdGenerator idGenerator, String Camunda, Connection connection, Connection connectiontarget) {
    ...
    public void run() throws SQLException, ClassNotFoundException {
        ...
        String selectQuery = "select FLD_WAREHOUSE_ENTERNARCOTIC_ID,FLD_NARCOTIC_TYPE_ID," +
                "FLD_MEASURMENT_UNIT_TYPE_ID,FLD_WAREHOUSE_ENTER_ID,FLD_AMOUNT,FLD_AMOUNT_LAFAFEH from " + sourceSchema + ".TBL_WAREHOUSE_ENTERNARCOTIC";
        ...
        String insertQuery =
                "Insert into " + targetSchema + ".NAP_INVENTORY_ITEM " +
                        ...
                        "    ) values (?,?,?,null,null,'root',sysdate,null,0,null,null,1 ," +
                        "null ,null,null ,null ,null ,null ,null ,null ,null ,null,null ,null ,null" +
                        ",sysdate,'root',null,null,null,null,null ,null ,null ,null,?,?,null ,null " +
                        ",null ,null,null,null ,null,null " +
                        ",?,?,null,null ,null,null,null ,'ACTIVE',null,?,null,null )";
        ...
        while (resultSet.next()) {
            ...
            String FLD_WAREHOUSE_ENTERNARCOTIC_ID = resultSet.getString("FLD_WAREHOUSE_ENTERNARCOTIC_ID");
            ...
            Double FLD_AMOUNT = resultSet.getDouble("FLD_AMOUNT");
            ...
            System.out.println(FLD_WAREHOUSE_ENTERNARCOTIC_ID);

            insertStmt.setString(1, FLD_WAREHOUSE_ENTERNARCOTIC_ID);
            insertStmt.setDouble(2, FLD_AMOUNT_LAFAFEHconvert);
            insertStmt.setDouble(3, FLD_AMOUNTconvert);
            insertStmt.setString(4, FLD_NARCOTIC_TYPE_ID);
            insertStmt.setString(5, FLD_NARCOTIC_TYPE_ID);
            insertStmt.setString(6, INSPECTION_MEETING_NOTE_ID);
            insertStmt.setString(7, FLD_WAREHOUSE_ID);
            insertStmt.setString(8, FLD_MEASURMENT_UNIT_TYPE_ID);
