...
public class MavadPoliceGrade {
    ...
    public MavadPoliceGrade(String targetSchema, String sourceSchema, IdGenerator idGenerator, String Camunda, Connection connection , Connection connectiontarget) {
    ...
    public void run() throws SQLException, ClassNotFoundException {
        ...
        String selectQuery = "select FLD_DEGREE_TYPE_ID,FLD_DESC from " +sourceSchema+".TBL_DEGREE_TYPE" ;


        //TODO: Organ code should be filled with personel code or smth like that!!!
        String insertQuery = "Insert into " + targetSchema +".NAP_POLICE_GRADE(" +
                "    POLICE_GRADE_ID        ,\n" +
                "    TITLE      ,\n" +
                "    RANK    )\n" +
                "values ( ?,?,null)\n";
        ...
        while(resultSet.next()){
            ...
            String FLD_DEGREE_TYPE_ID = resultSet.getString("FLD_DEGREE_TYPE_ID");
            String FLD_DESC = resultSet.getString("FLD_DESC");

            insertStmt.setLong(1, Long.parseLong(FLD_DEGREE_TYPE_ID));
