...
public class MavadEmbedType {
    ...
    public MavadEmbedType(String targetSchema, String sourceSchema, IdGenerator idGenerator, String Camunda, Connection connection , Connection connectiontarget) {
    ...
    public void run() throws SQLException, ClassNotFoundException {
        ...
        String selectQuery = "select FLD_EMBED_TYPE_ID,FLD_DESC from " +sourceSchema+".TBL_EMBED_TYPE" ;


        String insertQuery = "Insert into " + targetSchema +".NAP_EMBED_TYPE(EMBED_TYPE_ID, TITLE)\n" +
                "values (?,?)\n";
        ...
        while(resultSet.next()){
            ...
            insertStmt.setLong(1, Long.parseLong(FLD_EMBED_TYPE_ID));
