...
public class MavadCoachTrainingCourse {
    ...
    public MavadCoachTrainingCourse(String targetSchema, String sourceSchema, IdGenerator idGenerator,Connection connection , Connection connectiontarget) {
    ...
    public void run() throws SQLException, ClassNotFoundException {
        ...
        String insertQuery = "Insert into " + targetSchema +".NAP_COACH_TRAINING_COURSE(" +
                "    COACH_TRAINING_COURSE_ID        ,\n" +
                "    COURSE_CODE      ,\n" +
                "    TITLE     )\n" +
                "values (?,null,?)\n";
