...
public class MavadPLanGroup {
    ...
    public MavadPLanGroup(String targetSchema, String sourceSchema, IdGenerator idGenerator,Connection connection , Connection connectiontarget) {
    ...
    public void run() throws SQLException, ClassNotFoundException {
        ...
        String selectQuery = "select FLD_PLAN_EXECUTION_METHOD_ID,FLD_DESC from " +sourceSchema+".TBL_PLAN_EXECUTION_METHOD" ;
        ...
        while(resultSet.next()){
            ...
            insertStmt.setLong(1, Long.parseLong(FLD_PLAN_EXECUTION_METHOD_ID));
